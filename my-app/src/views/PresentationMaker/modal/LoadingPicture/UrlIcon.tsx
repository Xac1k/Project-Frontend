...
export function UrlIcon({ className }: UrlIconProps) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="680" height="810" viewBox="0 0 680 810" className={className}>
      <title>Url SVG Icon</title>
      <path
        fill="currentColor"
