...
export function CancelIcon({ className, onClick }: Props) {
  className = className ?? "";
  return (
    <svg onClick={onClick} className={className} xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
      <title>Cancellationx SVG Icon</title>
      <path
        fill="#2B3B47"
